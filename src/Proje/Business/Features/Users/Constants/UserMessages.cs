namespace Business.Features.Users.Constants
{
    public class UserMessages
    {
        ...
        public const string UserNameAvaliable = "user name avaliable";
        public const string UserNameNotAvaliable = "user name not avaliable";
